...
# base_list - это база данных как SQL, не может хранить классов, функций и методов. 
# Хранится где-то на сервере
base_list = open("base.json","r",encoding="utf-8")
# # registered_users - обработанная база данных с сервера, которая хранит в себе весь функционал пользователя
# registered_users = [

# ]

# # r - только чтение файла read()
# # w - перезапись текста в файле
...
# ["747278"/"747234"/"747316"/"747226"/"744698"/"747154"/"748846"/"747802"/"747562"/"746668"/"745996"/"745508"/"744602"/"743036"/"742146"] ["RskullW"] ["/companies/ru_mts/articles/" / "/hub/open_source/"]